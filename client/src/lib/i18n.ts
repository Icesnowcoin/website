...
export const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'about.desc2': '通过融合人工智能、区块链技术和游戏产业，ISC 正在创造一个全新的数字经济生态系统，让每一位参与者都能在虚拟与现实之间自由穿梭。',
  ...
  en: {
    ...
    'about.desc2': 'By integrating artificial intelligence, blockchain technology, and the gaming industry, ISC is creating a brand-new digital economic ecosystem where every participant can freely traverse between virtual and reality.',
