...
const DEX_PLATFORMS: DexPlatform[] = [
  ...
  },
  {
    ...
    logo: 'https://defillama.com/icons/protocols/biswap.png',
    description: 'BSC Exchange',
  },
  {
    name: 'ApeSwap',
    url: 'https://apeswap.finance',
    logo: 'https://defillama.com/icons/protocols/apeswap.png',
    description: 'Multi-chain DEX',
  },
  {
    name: 'MDEX',
    url: 'https://mdex.com',
    logo: 'https://defillama.com/icons/protocols/mdex.png',
    description: 'Hybrid Exchange',
  },
  {
    name: 'BabySwap',
    url: 'https://babyswap.finance',
    logo: 'https://defillama.com/icons/protocols/babyswap.png',
    description: 'Community DEX',
  },
  {
    name: 'Nomiswap',
    url: 'https://nomiswap.io',
    logo: 'https://defillama.com/icons/protocols/nomiswap.png',
    description: 'Stable Swap',
  },
  {
    name: 'Thena',
    url: 'https://thena.fi',
    logo: 'https://defillama.com/icons/protocols/thena.png',
    description: 'Optimized DEX',
  },
  {
    name: 'Uniswap',
    url: 'https://app.uniswap.org',
    logo: 'https://defillama.com/icons/protocols/uniswap.png',
    description: 'Multi-chain DEX',
  },
  {
    name: 'SushiSwap',
    url: 'https://www.sushi.com',
    logo: 'https://defillama.com/icons/protocols/sushiswap.png',
    description: 'Community DEX',
  },
  {
    name: 'Curve',
    url: 'https://curve.fi',
    logo: 'https://defillama.com/icons/protocols/curve.png',
    description: 'Stablecoin DEX',
  },
  {
    name: 'CowSwap',
    url: 'https://cow.fi',
    logo: 'https://defillama.com/icons/protocols/cow-swap.png',
    description: 'Intent-based DEX',
  },
  {
    name: 'dYdX',
    url: 'https://dydx.exchange',
    logo: 'https://defillama.com/icons/protocols/dydx.png',
    description: 'Trading Platform',
  },
  {
    name: '1inch',
    url: 'https://app.1inch.io',
    logo: 'https://defillama.com/icons/protocols/1inch.png',
    description: 'DEX Aggregator',
  },
  {
    name: 'ParaSwap',
    url: 'https://app.paraswap.io',
    logo: 'https://defillama.com/icons/protocols/paraswap.png',
    description: 'DEX Aggregator',
  },
  {
    name: 'OpenOcean',
    url: 'https://openocean.finance',
    logo: 'https://defillama.com/icons/protocols/openocean.png',
    description: 'DEX Aggregator',
  },
  {
    name: 'KyberSwap',
    url: 'https://kyberswap.com',
    logo: 'https://defillama.com/icons/protocols/kyberswap.png',
    description: 'Multi-chain DEX',
  },
];
